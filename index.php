<?php
	...
	*/
	...
	function remote_login($user_login, $user)
	{
		...
		$url = "http://chatwee-api.com/api/remotelogin?chatId=".$chatId."&clientKey=".$clientKey."&login=".$user_login."&isAdmin=".$isAdmin."&ipAddress=".$ip."&avatar=".$avatar."&isMobile=".$ismobile;
